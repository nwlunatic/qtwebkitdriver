...
#ifndef CHROME_TEST_QTWEBKITDRIVER_WINDOW_COMMANDS_H_
#define CHROME_TEST_QTWEBKITDRIVER_WINDOW_COMMANDS_H_
...
#endif  // CHROME_TEST_QTWEBKITDRIVER_WINDOW_COMMANDS_H_
