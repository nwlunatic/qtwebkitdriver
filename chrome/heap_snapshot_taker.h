...
#ifndef CHROME_TEST_QTWEBKITDRIVER_CHROME_HEAP_SNAPSHOT_TAKER_H_
#define CHROME_TEST_QTWEBKITDRIVER_CHROME_HEAP_SNAPSHOT_TAKER_H_
...
#endif  // CHROME_TEST_QTWEBKITDRIVER_CHROME_HEAP_SNAPSHOT_TAKER_H_
