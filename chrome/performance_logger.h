...
#ifndef CHROME_TEST_QTWEBKITDRIVER_CHROME_PERFORMANCE_LOGGER_H_
#define CHROME_TEST_QTWEBKITDRIVER_CHROME_PERFORMANCE_LOGGER_H_
...
#endif  // CHROME_TEST_QTWEBKITDRIVER_CHROME_PERFORMANCE_LOGGER_H_
