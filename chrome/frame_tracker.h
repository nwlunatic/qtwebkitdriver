...
#ifndef CHROME_TEST_QTWEBKITDRIVER_CHROME_FRAME_TRACKER_H_
#define CHROME_TEST_QTWEBKITDRIVER_CHROME_FRAME_TRACKER_H_
...
#endif  // CHROME_TEST_QTWEBKITDRIVER_CHROME_FRAME_TRACKER_H_
