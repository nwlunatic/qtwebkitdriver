...
#ifndef CHROME_TEST_QTWEBKITDRIVER_CHROME_AUTOMATION_EXTENSION_H_
#define CHROME_TEST_QTWEBKITDRIVER_CHROME_AUTOMATION_EXTENSION_H_
...
#endif  // CHROME_TEST_QTWEBKITDRIVER_CHROME_AUTOMATION_EXTENSION_H_
